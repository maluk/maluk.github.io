...
Status on 2026-09-23: the branch exports the homepage, all 50 current-year state pages, and four 2025 historical pages. It has 128 passing calculation tests. The branch is not deployed; CI currently uploads the static build as an artifact. The V2 definition of done is not yet met.
