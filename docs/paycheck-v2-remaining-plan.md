...
Status on 2026-09-23: the branch exports the homepage, all 50 current-year state pages, and four 2025 historical pages. The accuracy review is recorded in [the release audit](paycheck-v2-release-audit.md); 133 calculation tests and the static export check pass. The branch is awaiting GitHub Pages deployment and live HTTP checks. The V2 definition of done is not yet met.
