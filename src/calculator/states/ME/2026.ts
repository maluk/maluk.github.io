...
const metadata: TaxRuleMetadata = {
  jurisdiction: 'ME', taxYear: 2026, effectiveFrom: '2026-01-01', effectiveTo: '2026-12-31',
  lastVerified: '2026-09-22', status: 'verified', version: '2026.2', sources: [
    ...
    { title: '2026 Paid Family and Medical Leave employer FAQ', authority: 'Maine Department of Labor', url: 'https://www.maine.gov/paidleave/docs/2026/employers/faq/wmployerFAQenglish.pdf' },
  ],
};
...
export const me2026: StateCalculator = {
  ...
  getAssumptions: () => [
    'Maine uses its August 2026 revised percentage method, including the phaseout of the withholding standard deduction and the high-income surcharge.',
